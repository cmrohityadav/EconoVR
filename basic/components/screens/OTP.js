  ...
  return (
    ...
    >
        ...
        >
            ...
            >
            <Text style={{fontSize:36, marginVertical:60,color:'#111',fontFamily:'Montserrat'}}>
                Telegram
            </Text>

            <Text style={{fontSize:25,color:'#111',fontFamily:'Montserrat'}}>Verify Phone Number</Text>
